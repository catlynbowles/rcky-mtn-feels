describe('Home Page', () => {
  it('Should load', () => {
    ...
    cy.intercept('GET', 'https://arcane-hollows-12884.herokuapp.com/https://wefeel.csiro.au/main/api/zones/continents/northAmerica/timezones/timepoints?primaryEmotion=joy', {fixture: "localTotals"})
  })
